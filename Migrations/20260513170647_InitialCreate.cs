        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeriesNumber = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    GenreId = table.Column<long>(type: "INTEGER", nullable: true),
                    LanguageId = table.Column<long>(type: "INTEGER", nullable: true),
                    ...
                    Published = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AuthorsAuthorId = table.Column<long>(type: "INTEGER", nullable: false),
                    BooksBookId = table.Column<long>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
